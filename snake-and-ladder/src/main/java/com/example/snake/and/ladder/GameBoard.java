...
//         }
//         });
//         if(nextPosition[0]!=nextCell)System.out.println("The player" + player.getPlayerName() + "Has Bitten by a snake");
//         ladders.forEach(v->{
//         if(v.startPoint == nextCell){
//         nextPosition[0] = v.endPoint;
//         b[0] = true;
//         }
//         });
//         if(nextPosition[0]!=nextCell && b[0])System.out.println("The Player "+ player.getPlayerName() +" got a Ladder");
//         if(nextPosition[0] == boardSize) {
//         System.out.println("Player"+ player.getPlayerName() +"has won the game");
//         }else{
//         playersCurrentPosition.put(player.getPlayerName(),nextPosition[0]);
